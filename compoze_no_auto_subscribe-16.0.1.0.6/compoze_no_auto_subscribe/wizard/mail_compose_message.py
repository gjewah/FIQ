...
class mail_compose_message(models.TransientModel):
    ...
    subscribe_recipients = fields.Boolean(
        ...
        help="If checked, all recipients stated above will be added to the document followers.",
    )
    ...
    def _action_send_mail(self, auto_commit=False):
        ...
        return super(mail_compose_message, self)._action_send_mail(auto_commit=auto_commit)
