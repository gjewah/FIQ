...
FieldFilter.supportedTypes = ["char"];
FieldFilter.template = "total_notify.FieldFilter";
FieldFilter.components = { ModelFieldSelector };
FieldFilter.props = {...standardFieldProps };
